...
| [`change-request-writing`](skills/change-request-writing/SKILL.md) | 编写或更新 GitHub/GitLab Issue、PR、MR 与 inline review reply；聚焦 final net diff、设计取舍、Breaking Change，并避免低价值验证噪声与本地路径泄露。 |
