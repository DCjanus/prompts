---
name: github-cli
description: 使用 GitHub CLI 与 GitHub 资源交互；适用于 repo、issue、PR、comment、release、workflow 等查看、更新或创建场景；Issue/PR 标题正文编写配合 change-request-writing。
---
...
2. Issue/PR 标题与正文编写统一遵循 [change-request-writing](../change-request-writing/SKILL.md)。
...
更新标题或正文时，文案仍按 [change-request-writing](../change-request-writing/SKILL.md) 重新生成。
