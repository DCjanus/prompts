...
需要可点击链接时，默认使用 Markdown URL，不裸贴长 URL。

- 上游 issue / PR / commit / discussion 链接在低干扰场景默认使用 `redirect.github.com`，例如 `[RedisShake PR 1050](https://redirect.github.com/tair-opensource/RedisShake/pull/1050)`。
